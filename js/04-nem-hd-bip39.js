/**
 * 04-nem-hd-bip39.js — BIP-39: English wordlist (2048 words), mnemonic
 * generation from entropy, mnemonic validation, and mnemonic -> seed
 * (PBKDF2-HMAC-SHA512, 2048 rounds, per BIP-39).
 * Depends on: 01-nem-hd-bytes.js, 02-nem-hd-hash.js, 03-nem-hd-pbkdf2.js.
 */
(function () {
  'use strict';
  var NemHD = window.NemHD;
  var sha256 = NemHD.sha256;
  var pbkdf2Sha512 = NemHD.pbkdf2Sha512;
...
"yellow","you","young","youth","zebra","zero","zone","zoo"
  ...
  NemHD.WORDLIST = WORDLIST;
  NemHD.generateMnemonic = generateMnemonic;
  NemHD.entropyToMnemonic = entropyToMnemonic;
  NemHD.validateMnemonic = validateMnemonic;
  NemHD.mnemonicToSeed = mnemonicToSeed;
})();
